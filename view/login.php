    	...
    	<div class="modal-dialog">    
        	<div class="modal-content ">
        		<div class="modal-header bg-aqua-gradient">
          			<h4>Student Management System Login Panel...!</h4>
        		</div>
        		<div class="modal-body bgColorWhite">
        			<form role="form" action="../index.php" method="post">                    
						  ...
						  <div><a href="reset\index.php"><u>Forgot your password?</u></a></div>
						  ...
						  <div><a href="registration\register.php">Are you new?<u>SignUp..!</u></a></div>
	...
	<div class="modal fade" id="login_error" tabindex="-1" role="dialog" aria-labelledby="insert_alert1" aria-hidden="true">
    	<div class="modal-dialog">    
      		<div class="modal-content">
        		...
        		<div class="modal-body bgColorWhite">
        			<strong style="color:red; font-size:14px">Incorrect!</strong> Email or Password is Incorrect.
        		</div>
			</div>
		</div>
	</div><!--/.Modal-->
